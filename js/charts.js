(function () {
  ...
  function initSectionCharts() {
    var lifespanEl = document.getElementById("lifespanChart");
    if (lifespanEl) chartState.lifespan = new Chart(lifespanEl, {
      type: "bar",
      data: {
        labels: ["Methane", "CO2"],
        datasets: [{
    ...
    var methaneEl = document.getElementById("methaneWarmingChart");
    if (methaneEl) chartState.methaneWarming = new Chart(methaneEl, {
      type: "line",
      data: {
    ...
    var phaseEl = document.getElementById("phaseChart");
    if (phaseEl) chartState.phase = new Chart(phaseEl, {
      type: "bar",
      data: {
